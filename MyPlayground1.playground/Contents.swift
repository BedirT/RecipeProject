...
dict.updateValue(Set(["Baba Gournish"]), forKey: "items")
...
dict.updateValue(Set(["Really Fudgy Brownies"]), forKey: "items")
...
dict.updateValue(Set(["Simple Healthy Summer Salad"]), forKey: "items")
...
dict.updateValue(Set(["Fried Mashed Patatoes"]), forKey: "items")
...
dict.updateValue(Set(["Chocolate Truffle Cake"]), forKey: "items")
