...
class Data: UIView {
    ...
    func myFunc() -> ( myset: [String], array: Array<Dictionary<String,Any>>) {
...
//        dict.updateValue(Set(["Eggplant,Onions,Garlic,Lemon,Parsley"]), forKey: "items")
//        
//        arr.append(dict)
//        
...
//        dict.updateValue(Set(["Butter,Chocolate,Eggs,Sugar,Vanilla,Flour"]), forKey: "items")
//        
//        arr.append(dict)
//        
//        
...
//        dict.updateValue(Chocolate,Butter,Sugar,Egg,Flour,Egg,Sugar"]), forKey: "items")
//        
//        arr.append(dict)
//        
//        
...
//        dict.updateValue(Set(["Steaks,Vegetable oil]), forKey: "items")
        ...
        //dict.updateValue("Gnocchi: "title")
        ...
        allItems.append(arr[0]["items"] as! String)
        allItems.append(arr[1]["items"] as! String)
        
        
//      for var i = 0 ; i < arr.count ; i++ {
//          var inserting = arr[i]["items"] as! String
//          for var j = 0 ; j < dict.count ; j++ {
//              allItems.append(inserting[inserting.startIndex.advancedBy(j)])
//          }
//      }
